...
- Maintain static and dynamic stability
- Ensure realistic manufacturability using commercially available components

---

## High-Level Approach
- Conceptual aircraft configuration selection
- Weight estimation and CG analysis
- Static margin evaluation
- Stability analysis using aerodynamic tools
- Hybrid power system modelling

*(Detailed propulsion modelling and system integration methods reserved for future development.)*
...
## Tools Used
XFLR5 • MATLAB • Aircraft Design Methods • Stability Analysis Techniques

---

## Status
Design phase completed. Prototype-level validation and propulsion testing under future scope.
